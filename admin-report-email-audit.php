                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 col-lg-2">
                                        <h5 class="text-primary"><b>Email Report</b></h5>
                                    </div>
                                    <div class="col-12 col-lg-10 mb-4">
                                        <form action="xlsx-email-report-audit.php" method="POST">
                                            <div class="row">
                                    ...
                                    <table class="w-100 table-striped mt-4">
                                        ...
                                        <tbody>
                                            <?php
                                            require 'dbconn.php';
                                            $sql = "SELECT `loginID`,`employeeName`,`managerName`,`callType`,`callDate`,`auditDate`,`achievedScore`,`scoreWithFatal`,`scoreWithoutFatal`,`auditedAt` FROM email_call_monitoring ORDER BY id ";
