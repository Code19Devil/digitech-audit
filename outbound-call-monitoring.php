...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $sql = "Select * from(Select * from(SELECT * FROM audit_report WHERE  status= 'pending' AND lob = 'outbound' and disposition is not null ANd is_active =1";
  ...
  $sql = "SELECT * FROM audit_report WHERE status= 'pending' AND assignedTo = '$loginid' AND lob = 'outbound' AND disposition is not null ANd is_active =1 Order by assignedTime desc  limit 1";
  $result = mysqli_query($link, $sql);
            ...
            <div class="card">
              <div class="card-body">
                <div class="col-12 col-lg-12">
                  <h5><b>Outbound Audited Users</b></h5>
                </div>
                <div class="card shadow p-4">
                  <div class="row">
                    ...
                    <div class="col-lg-3 col-12 m-auto">
                      <?php $res = mysqli_query($link, "SELECT COUNT(*) AS `count` FROM audit_report WHERE status= 'closed' AND assignedTo = '$loginid' AND lob = 'outbound'");
                  ...
                  <form action="xls-agent-outbound-report-audit.php" method="POST">
                    <div class="row">
                      <div class="col-4 col-lg-4">
                        <label for="dateFrom">Date From</label>
                        <input type="date" name="dateFrom" value="<?php print(date('Y-m-d', strtotime('-1 month'))) ?>" id="dateFrom" class="form-control">
                      </div>
                      <div class="col-4 col-lg-4">
                  ...
                  <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    <div class="row mt-4">
                      ...
                      <div class="col-4 col-lg-2">
                        <label for="dateTo">Date To</label>
                        <input type="date" name="dateTo" value="<?php print (date('Y-m-d', strtotime('+1 days'))) ?>"
                    ...
                    <?php if (mysqli_num_rows($result) > 0): ?>
                      <?php while ($row = mysqli_fetch_assoc($result)): ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="outbound-call-monitoring-details.php?agentCallid=<?php print $row['agentCallid']; ?>&id=<?php print $row['id']; ?>"
...
<script>
  window.onpopstate = function (event) {
    if (event) {
      window.location.href = '<?php echo $baseURL ?>outbound-call-monitoring.php';
    }
  };
</script>
</body>
