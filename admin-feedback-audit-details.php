...
<?php ($role != 1) ? print("<script>window.location.href ='index.php';</script>") : '' ?>
                ...
                <div class="row border">
                    <div class="col-12 col-md-12 col-lg-12">
                        ...
                        <div class="row border p-2">
                            ...
                            <div class="col-3 col-lg-3">
                                <input type="text" name="employeeName" value="<?php print($row['employeeName']) ?>"
                                    class="form-control" readonly utocomplete="off">
                            </div>
                        ...
                        <div class="row border p-2">
                            ...
                            <div class="col-3 col-lg-3"><b> Caller No :</b></div>
                            <div class="col-3 col-lg-3">
                                <input type="text" name="callerNo" value="<?php print($row['callerNo']) ?>"
                                    class="form-control" readonly>
                            </div>
                        </div>
                        <div class="row border p-2">
