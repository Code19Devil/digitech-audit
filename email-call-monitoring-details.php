...
if ($totalCount == $target) {
    print("<script>alert('Monthly Target Of $target Audit Achieved');window.location.href='email-call-monitoring.php'</script>");
}
?>
<?php
$loginid = $_SESSION['loginid'];
                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="bg-primary row rounded">
                            <div class="text-center w-100 p-2">
                                ...
                                <h5><b>Email Call Monitoring Form</b></h5>
                            </div>

                        </div>
                        <form class="mt-4" action="email-call-monitoring-process.php" method="POST">
                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table">
                            ...
                            <?php
                            $allQtag = array();
                            $getQuestions = mysqli_query($link, "SELECT * FROM email_question_set");
...
<?php
$allFtlQ = mysqli_query($link, "SELECT qTag FROM email_question_set WHERE isFatal!=''");
$fatalQue = array();
...
<script>
    function getScore(qid) {
        ...
        $.ajax({
            url: "email-calculating-score.php",
            type: "POST",
            data: {
                qid: qid,
                qVal: qVal,
